...
public class AddSupplierAttachmentCommandValidator : AbstractValidator<AddSupplierAttachmentCommand>
{
    public AddSupplierAttachmentCommandValidator()
    {
        ...
        RuleFor(x => x.Title)
            .NotEmpty()
            .WithMessage("عنوان پیوست الزامی است")
            .MaximumLength(150)
            .WithMessage("عنوان پیوست نباید بیشتر از ۱۵۰ کاراکتر باشد");

        RuleFor(x => x.FileUrl)
            .NotEmpty()
            .WithMessage("آدرس فایل الزامی است")
            .MaximumLength(1000)
            .WithMessage("آدرس فایل نباید بیشتر از ۱۰۰۰ کاراکتر باشد")
