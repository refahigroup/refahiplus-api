...
public class AddAgreementProductCommandHandler
    : IRequestHandler<AddAgreementProductCommand, AddAgreementProductResponse>
{
    ...
    public async Task<AddAgreementProductResponse> Handle(
        AddAgreementProductCommand request,
