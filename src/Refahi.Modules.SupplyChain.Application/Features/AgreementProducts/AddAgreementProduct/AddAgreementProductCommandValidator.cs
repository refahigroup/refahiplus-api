...
public class AddAgreementProductCommandValidator : AbstractValidator<AddAgreementProductCommand>
{
    public AddAgreementProductCommandValidator()
    {
        ...
        RuleFor(x => x.Name)
            ...
            .MaximumLength(200)
            .WithMessage("نام محصول نباید بیشتر از ۲۰۰ کاراکتر باشد");
        ...
        RuleFor(x => x.DeliveryType)
            .InclusiveBetween((short)1, (short)3)
            .WithMessage("نوع تحویل نامعتبر است");
