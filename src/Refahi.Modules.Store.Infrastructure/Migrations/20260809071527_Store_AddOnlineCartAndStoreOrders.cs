...
namespace Refahi.Modules.Store.Infrastructure.Migrations
{
    ...
    public partial class Store_AddOnlineCartAndStoreOrders : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VariantTitle = table.Column<string>(
                        type: "character varying(300)",
                        maxLength: 300,
                        nullable: true
                    ),
                    SessionTitle = table.Column<string>(
                        type: "character varying(300)",
                        maxLength: 300,
                        nullable: true
                    ),
        ...
        {
            migrationBuilder.DropTable(name: "store_order_items", schema: "store");

            migrationBuilder.DropTable(name: "store_orders", schema: "store");
            ...
            migrationBuilder.DropColumn(name: "OfferId", schema: "store", table: "cart_items");
