...
namespace Refahi.Modules.Store.Infrastructure.Migrations
{
    ...
    public partial class Store_AddCatalogProductsAndOffers : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartDateUtc = table.Column<DateTimeOffset>(
                        type: "timestamp with time zone",
                        nullable: false
                    ),
                    EndDateUtc = table.Column<DateTimeOffset>(
                        type: "timestamp with time zone",
                        nullable: true
                    ),
        ...
        {
            migrationBuilder.DropTable(name: "offers", schema: "store");
            ...
            migrationBuilder.DropColumn(name: "SupplierId", schema: "store", table: "products");
        }
    }
}
