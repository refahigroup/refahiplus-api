...
namespace Refahi.Modules.Store.Infrastructure.Migrations
{
    ...
    public partial class Store_AddVoucherLifecycle : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShopName = table.Column<string>(
                        type: "character varying(200)",
                        maxLength: 200,
                        nullable: false
                    ),
                    ProductId = table.Column<Guid>(type: "uuid", nullable: false),
                    ProductTitle = table.Column<string>(
                        type: "character varying(300)",
                        maxLength: 300,
                        nullable: false
                    ),
                    ...
                    CodeCiphertext = table.Column<string>(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestFingerprint = table.Column<string>(
                        type: "character varying(64)",
                        maxLength: 64,
                        nullable: false
                    ),
        ...
        {
            migrationBuilder.DropTable(name: "voucher_redemptions", schema: "store");

            migrationBuilder.DropTable(name: "vouchers", schema: "store");
        }
    }
}
