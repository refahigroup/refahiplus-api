...
namespace Refahi.Modules.Store.Infrastructure.Migrations
{
    ...
    public partial class Store_AddVoucherRefundOverride : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentAction = table.Column<string>(
                        type: "character varying(32)",
                        maxLength: 32,
                        nullable: true
                    ),
        ...
        {
            migrationBuilder.DropTable(name: "voucher_refund_override_attempts", schema: "store");

            migrationBuilder.DropTable(name: "voucher_refund_overrides", schema: "store");
        }
    }
}
