...
public class CapturePaymentIntentEndpoint : IEndpoint
{
    public void Map(object app)
    {
        ...
        routes.MapPost("/payments/intents/{intentId:guid}/capture", async (
            Guid intentId,
            ...
            CancellationToken ct) =>
        {
            ...
            var command = new CapturePaymentIntentCommand(
                IntentId: intentId,
            ...
            try
            {
                ...
                if (resp.Status == CommandStatus.InProgress)
                    return Results.AcceptedAtRoute(
                        ...
                        new ErrorResponse(
                            "IN_PROGRESS", 
                            "The payment capture is currently pending. Retry later using the same Idempotency-Key."));
        ...
        .Produces<CapturePaymentIntentResponse>(StatusCodes.Status200OK)
