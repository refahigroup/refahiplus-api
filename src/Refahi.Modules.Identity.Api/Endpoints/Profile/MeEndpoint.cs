    ...
    public void Map(object app)
    {
        ...
        routes
            .MapGet(
                ...
                async (System.Security.Claims.ClaimsPrincipal userPrincipal, IMediator mediator) =>
                {
                    var id = userPrincipal
                    ...
                    return Results.Ok(
                        ApiResponseHelper.Success(me, "اطلاعات کاربر با موفقیت دریافت شد")
                    );
                }
            )
