...
using Refahi.Modules.Pool.Application;
using Refahi.Modules.Pool.Infrastructure;
using Microsoft.Extensions.Hosting;

namespace Refahi.Modules.Pool.Api;

public static class DI
{
    public static IServiceCollection RegisterPoolModule(this IServiceCollection services, IConfiguration configuration
    )
    {
    ...
    public static WebApplication UsePoolModule(
