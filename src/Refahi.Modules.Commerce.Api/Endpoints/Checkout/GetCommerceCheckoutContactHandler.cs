...
namespace Refahi.Modules.Commerce.Application.NewFolder;

public sealed class GetCommerceCheckoutContactHandler(IMediator mediator) : IRequestHandler<GetCommerceCheckoutContactQuery, CommerceCheckoutContactDto>
{
