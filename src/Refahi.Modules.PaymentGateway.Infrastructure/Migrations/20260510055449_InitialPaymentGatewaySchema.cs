...
namespace Refahi.Modules.PaymentGateway.Infrastructure.Migrations
{
    ...
    public partial class InitialPaymentGatewaySchema : Migration
    {
        ...
        {
            migrationBuilder.EnsureSchema(name: "payment_gateway");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    return_base_url = table.Column<string>(
                        type: "character varying(500)",
                        maxLength: 500,
                        nullable: false
                    ),
                    succeeded_callback_url = table.Column<string>(
                        type: "character varying(500)",
                        maxLength: 500,
                        nullable: true
                    ),
                    failed_callback_url = table.Column<string>(
                        type: "character varying(500)",
                        maxLength: 500,
                        nullable: true
                    ),
                    provider_token = table.Column<string>(
                        type: "character varying(1000)",
                        maxLength: 1000,
                        nullable: true
                    ),
                    provider_ref_num = table.Column<string>(
                        type: "character varying(100)",
                        maxLength: 100,
                        nullable: true
                    ),
                    provider_trace_no = table.Column<string>(
                        type: "character varying(100)",
                        maxLength: 100,
                        nullable: true
                    ),
                    provider_secure_pan = table.Column<string>(
                    ...
                    provider_result_description = table.Column<string>(
                        type: "character varying(500)",
                        maxLength: 500,
                        nullable: true
                    ),
                    initiated_at = table.Column<DateTimeOffset>(
        ...
        {
            migrationBuilder.DropTable(name: "sessions", schema: "payment_gateway");
        }
    }
}
