...
public sealed class FlightOfferSnapshotConfiguration : IEntityTypeConfiguration<FlightOfferSnapshot>
{
    public void Configure(EntityTypeBuilder<FlightOfferSnapshot> builder)
    {
        ...
        builder.Property(offer => offer.Id).ValueGeneratedNever().HasColumnName("id");

        builder
            .Property(offer => offer.OfferToken)
            .IsRequired()
            .HasMaxLength(120)
            .HasColumnName("offer_token");

        builder
            .Property(offer => offer.ProviderName)
            .IsRequired()
            .HasMaxLength(100)
        ...
        builder
            .Property(offer => offer.ProviderSearchId)
            .HasMaxLength(200)
            .HasColumnName("provider_search_id");

        builder
            .Property(offer => offer.ProviderTraceId)
            .HasMaxLength(200)
        ...
        builder
            .Property(offer => offer.PublicOfferSnapshotJson)
            .IsRequired()
            .HasColumnType("jsonb")
            .HasColumnName("public_offer_snapshot");

        builder
            .Property(offer => offer.ProviderSnapshotJson)
            .HasColumnType("jsonb")
            .HasColumnName("provider_snapshot");

        builder.Property(offer => offer.CreatedAtUtc).IsRequired().HasColumnName("created_at_utc");

        builder.Property(offer => offer.ExpiresAtUtc).IsRequired().HasColumnName("expires_at_utc");

        builder
            .HasIndex(offer => offer.OfferToken)
            .IsUnique()
            .HasDatabaseName("ux_flight_search_offer_snapshots_offer_token");

        builder
            .HasIndex(offer => offer.ExpiresAtUtc)
