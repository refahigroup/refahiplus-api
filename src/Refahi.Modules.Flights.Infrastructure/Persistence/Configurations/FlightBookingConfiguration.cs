...
public sealed class FlightBookingConfiguration : IEntityTypeConfiguration<FlightBooking>
{
    public void Configure(EntityTypeBuilder<FlightBooking> builder)
    {
        ...
        builder.Property(booking => booking.UserId).IsRequired().HasColumnName("user_id");
        ...
        builder.Property(booking => booking.OrderId).HasColumnName("order_id");

        builder
            .Property(booking => booking.OrderNumber)
            .HasMaxLength(50)
            .HasColumnName("order_number");

        builder
            .Property(booking => booking.IdempotencyKey)
            .IsRequired()
            .HasMaxLength(200)
            .HasColumnName("idempotency_key");

        builder
            .Property(booking => booking.CreatedAtUtc)
            .IsRequired()
            .HasColumnName("created_at_utc");

        builder
            .Property(booking => booking.UpdatedAtUtc)
            .IsRequired()
            .HasColumnName("updated_at_utc");

        builder.Property(booking => booking.ExpiresAtUtc).HasColumnName("expires_at_utc");

        builder
            .Property(booking => booking.IssueFailureReason)
            .HasMaxLength(1000)
        ...
        builder.HasIndex(booking => booking.UserId).HasDatabaseName("ix_flight_bookings_user_id");

        builder
            .HasIndex(booking => booking.OrderId)
            .IsUnique()
            .HasDatabaseName("ux_flight_bookings_order_id");

        builder
            .HasIndex(booking => booking.IdempotencyKey)
            .IsUnique()
            .HasDatabaseName("ux_flight_bookings_idempotency_key");

        builder.HasIndex(booking => booking.Status).HasDatabaseName("ix_flight_bookings_status");
    }
    ...
    private static void ConfigureProvider(EntityTypeBuilder<FlightBooking> builder)
    {
        builder.OwnsOne(
            ...
            {
                provider
                    .Property(item => item.ProviderName)
                    .IsRequired()
                    .HasMaxLength(100)
                ...
                provider
                    .Property(item => item.ProviderCaption)
                    .IsRequired()
                    .HasMaxLength(200)
                    .HasColumnName("provider_caption");

                provider
                    .Property(item => item.ProviderTraceId)
                    .HasMaxLength(200)
                    .HasColumnName("provider_trace_id");

                provider
                    .Property(item => item.SnapshotJson)
                    .HasColumnType("jsonb")
    ...
    private static void ConfigureContact(EntityTypeBuilder<FlightBooking> builder)
    {
        builder.OwnsOne(
            ...
            {
                contact
                    .Property(item => item.MobileNumber)
                    .IsRequired()
                    .HasMaxLength(30)
    ...
    {
        builder.OwnsOne(
            booking => booking.ProviderBooking,
            providerBooking =>
            {
                providerBooking
                    .Property(item => item.ProviderBookingId)
                    .HasMaxLength(200)
                    .HasColumnName("provider_booking_id");

                providerBooking
                    .Property(item => item.ProviderBookingCaption)
                    .HasMaxLength(300)
                    .HasColumnName("provider_booking_caption");

                providerBooking
                    .Property(item => item.ProviderPnr)
                    .HasMaxLength(100)
                ...
                providerBooking
                    .Property(item => item.BookedAtUtc)
    ...
    {
        builder.OwnsOne(
            booking => booking.LatestCancellationQuote,
            quote =>
            {
    ...
    private static void ConfigurePassengers(EntityTypeBuilder<FlightBooking> builder)
    {
        builder.OwnsMany(
            ...
            passengers =>
            {
                ...
                passengers
                    .Property(passenger => passenger.Id)
                    .ValueGeneratedNever()
                    .HasColumnName("id");

                passengers
                    .Property(passenger => passenger.FirstName)
                    .IsRequired()
                    .HasMaxLength(150)
                    .HasColumnName("first_name");

                passengers
                    .Property(passenger => passenger.LastName)
                    .IsRequired()
                    .HasMaxLength(150)
                    .HasColumnName("last_name");

                passengers
                    .Property(passenger => passenger.Type)
                    .IsRequired()
                    .HasConversion<short>()
                    .HasColumnName("type");

                passengers
                    .Property(passenger => passenger.BirthDate)
                    .IsRequired()
                    .HasColumnType("date")
                    .HasColumnName("birth_date");

                passengers
                    .Property(passenger => passenger.NationalCode)
                    .HasMaxLength(30)
                    .HasColumnName("national_code");

                passengers
                    .Property(passenger => passenger.PassportNumber)
                    .HasMaxLength(50)
                    .HasColumnName("passport_number");

                passengers
                    .Property(passenger => passenger.NationalityCode)
                    .IsRequired()
                    .HasMaxLength(3)
                ...
                passengers
                    .HasIndex("flight_booking_id")
                    .HasDatabaseName("ix_flight_booking_passengers_booking_id");
            }
        );

        builder
            .Navigation(booking => booking.Passengers)
    ...
    private static void ConfigureSegments(EntityTypeBuilder<FlightBooking> builder)
    {
        builder.OwnsMany(
            ...
            segments =>
            {
                ...
                segments.Property(segment => segment.Id).ValueGeneratedNever().HasColumnName("id");

                segments
                    .Property(segment => segment.Sequence)
                    .IsRequired()
                    .HasColumnName("sequence");

                segments
                    .Property(segment => segment.ProviderSegmentId)
                    .IsRequired()
                    .HasMaxLength(200)
                    .HasColumnName("provider_segment_id");

                segments
                    .Property(segment => segment.FlightNumber)
                    .IsRequired()
                    .HasMaxLength(50)
                    .HasColumnName("flight_number");

                segments
                    .Property(segment => segment.AirlineCode)
                    .IsRequired()
                    .HasMaxLength(20)
                    .HasColumnName("airline_code");

                segments
                    .Property(segment => segment.AirlineName)
                    .IsRequired()
                    .HasMaxLength(200)
                    .HasColumnName("airline_name");

                segments
                    .Property(segment => segment.OriginAirportCode)
                    .IsRequired()
                    .HasMaxLength(10)
                    .HasColumnName("origin_airport_code");

                segments
                    .Property(segment => segment.OriginCaption)
                    .IsRequired()
                    .HasMaxLength(200)
                    .HasColumnName("origin_caption");

                segments
                    .Property(segment => segment.DestinationAirportCode)
                    .IsRequired()
                    .HasMaxLength(10)
                    .HasColumnName("destination_airport_code");

                segments
                    .Property(segment => segment.DestinationCaption)
                    .IsRequired()
                    .HasMaxLength(200)
                    .HasColumnName("destination_caption");

                segments
                    .Property(segment => segment.DepartureAtUtc)
                    .IsRequired()
                    .HasColumnName("departure_at_utc");

                segments
                    .Property(segment => segment.ArrivalAtUtc)
                    .IsRequired()
                    .HasColumnName("arrival_at_utc");

                segments
                    .HasIndex("flight_booking_id", nameof(FlightSegment.Sequence))
                    .IsUnique()
        ...
        builder
            .Navigation(booking => booking.Segments)
            .UsePropertyAccessMode(PropertyAccessMode.Field);
    }
    ...
    private static void ConfigureIssuedTickets(EntityTypeBuilder<FlightBooking> builder)
    {
        builder.OwnsMany(
            ...
            tickets =>
            {
                ...
                tickets.Property(ticket => ticket.Id).ValueGeneratedNever().HasColumnName("id");

                tickets
                    .Property(ticket => ticket.PassengerId)
                    .IsRequired()
                ...
                tickets
                    .Property(ticket => ticket.PassengerNameSnapshot)
                    .IsRequired()
                    .HasMaxLength(300)
                    .HasColumnName("passenger_name_snapshot");

                tickets
                    .Property(ticket => ticket.ProviderTicketId)
                    .HasMaxLength(200)
                    .HasColumnName("provider_ticket_id");

                tickets
                    .Property(ticket => ticket.ProviderTraceId)
                    .HasMaxLength(200)
                    .HasColumnName("provider_trace_id");

                tickets
                    .Property(ticket => ticket.SnapshotJson)
                    .HasColumnType("jsonb")
                    .HasColumnName("ticket_snapshot");

                tickets
                    .Property(ticket => ticket.IssuedAtUtc)
                    .IsRequired()
                ...
                tickets
                    .HasIndex(ticket => ticket.TicketNumber)
                    .HasDatabaseName("ix_flight_booking_tickets_ticket_number");
            }
        );

        builder
            .Navigation(booking => booking.IssuedTickets)
            .UsePropertyAccessMode(PropertyAccessMode.Field);
    }
    ...
    {
        builder.OwnsMany(
            booking => booking.CancellationRequests,
            requests =>
            {
                ...
                requests.Property(request => request.Id).ValueGeneratedNever().HasColumnName("id");
                ...
                requests
                    .Property(request => request.RequestedAtUtc)
                    .IsRequired()
                    .HasColumnName("requested_at_utc");

                requests
                    .Property(request => request.CompletedAtUtc)
                    .HasColumnName("completed_at_utc");

                requests
                    .Property(request => request.FailureReason)
                    .HasMaxLength(1000)
                    .HasColumnName("failure_reason");

                requests
                    .Property(request => request.ProviderCancellationId)
                    .HasMaxLength(200)
        ...
        builder
            .Navigation(booking => booking.CancellationRequests)
            .UsePropertyAccessMode(PropertyAccessMode.Field);
    }
    ...
    private static void ConfigureMoney<TOwner>(
        ...
        where TOwner : class
    {
        money.Property(item => item.Amount).IsRequired().HasColumnName($"{columnPrefix}_amount");

        money
            .Property(item => item.Currency)
            .IsRequired()
            .HasMaxLength(3)
        ...
        where TOwner : class
    {
        ...
        quote.Property(item => item.QuotedAtUtc).HasColumnName($"{columnPrefix}_quoted_at_utc");

        quote.Property(item => item.ExpiresAtUtc).HasColumnName($"{columnPrefix}_expires_at_utc");

        quote
            .Property(item => item.ProviderCancellationQuoteId)
            .HasMaxLength(200)
