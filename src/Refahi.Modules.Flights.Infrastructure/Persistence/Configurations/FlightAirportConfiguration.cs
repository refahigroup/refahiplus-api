...
public sealed class FlightAirportConfiguration : IEntityTypeConfiguration<FlightAirport>
{
    public void Configure(EntityTypeBuilder<FlightAirport> builder)
    {
        ...
        builder
            .Property(airport => airport.CityCode)
            .HasColumnName("city_code")
            .HasMaxLength(3)
            .IsRequired();
        builder
            .Property(airport => airport.AirportNameFa)
            .HasColumnName("airport_name_fa")
            .HasMaxLength(300)
            .IsRequired();
        builder
            .Property(airport => airport.AirportNameEn)
            .HasColumnName("airport_name_en")
            .HasMaxLength(300)
            .IsRequired();
        builder
            .Property(airport => airport.CityNameFa)
            .HasColumnName("city_name_fa")
            .HasMaxLength(200)
            .IsRequired();
        builder
            .Property(airport => airport.CityNameEn)
            .HasColumnName("city_name_en")
            .HasMaxLength(200)
            .IsRequired();
        builder
            .Property(airport => airport.CountryCode)
            .HasColumnName("country_code")
            .HasMaxLength(2)
            .IsRequired();
        builder
            .Property(airport => airport.CountryNameFa)
            .HasColumnName("country_name_fa")
            .HasMaxLength(200)
            .IsRequired();
        builder
            .Property(airport => airport.CountryNameEn)
        ...
        builder
            .Property(airport => airport.SourceVersion)
            .HasColumnName("source_version")
            .HasMaxLength(50)
            .IsRequired();
        builder
            .Property(airport => airport.TranslationSource)
            .HasColumnName("translation_source")
            .HasMaxLength(50)
            .IsRequired();
        builder
            .Property(airport => airport.SearchText)
            .HasColumnName("search_text")
            .HasColumnType("text")
            .IsRequired();
        builder
            .Property(airport => airport.ImportedAtUtc)
            .HasColumnName("imported_at_utc")
            .IsRequired();

        builder
            .HasIndex(airport => airport.IcaoCode)
            .HasDatabaseName("ix_flight_airports_icao_code");
        builder
            .HasIndex(airport => new { airport.IsActive, airport.IsPopular })
