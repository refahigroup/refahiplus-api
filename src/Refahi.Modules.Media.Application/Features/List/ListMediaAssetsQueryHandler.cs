...
public class ListMediaAssetsQueryHandler
    : IRequestHandler<ListMediaAssetsQuery, ListMediaAssetsResult>
{
    ...
    public async Task<ListMediaAssetsResult> Handle(
        ListMediaAssetsQuery request,
