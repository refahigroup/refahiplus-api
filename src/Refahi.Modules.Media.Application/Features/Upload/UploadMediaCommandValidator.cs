...
public class UploadMediaCommandValidator : AbstractValidator<UploadMediaCommand>
{
    ...
    public static readonly string[] AllowedVideoTypes = ["video/mp4", "video/webm"];
    ...
    public UploadMediaCommandValidator()
    {
        RuleFor(x => x.OriginalFileName)
            ...
            .MaximumLength(500)
            .WithMessage("نام فایل بسیار طولانی است");
        ...
        RuleFor(x => x.FileSizeBytes).GreaterThan(0).WithMessage("حجم فایل نامعتبر است");
        ...
        RuleFor(x => x.UploadedByUserId)
            .NotEmpty()
            .WithMessage("شناسه کاربر آپلودکننده الزامی است");
    }
}
