...
public sealed class HotelBookingSagaStateEntityTypeConfiguration
    : IEntityTypeConfiguration<HotelBookingSagaState>
{
    public void Configure(EntityTypeBuilder<HotelBookingSagaState> builder)
    {
        ...
        builder
            .Property(s => s.ProviderBookingStatus)
            .IsRequired()
            .HasConversion<short>()
        ...
        builder.Property(s => s.FailureReason).HasMaxLength(1000).HasColumnName("failure_reason");

        builder
            .Property(s => s.ProviderCancellationIdempotencyKey)
            .HasMaxLength(160)
            .HasColumnName("provider_cancellation_idempotency_key");

        builder
            .Property(s => s.ProviderCancellationReason)
            .HasMaxLength(1000)
            .HasColumnName("provider_cancellation_reason");

        builder
            .Property(s => s.ProviderCancellationRequestedAt)
            .HasColumnName("provider_cancellation_requested_at");

        builder
            .Property(s => s.ProviderCancellationCompletedAt)
            .HasColumnName("provider_cancellation_completed_at");

        builder.Property(s => s.ExternalUnresolvedAt).HasColumnName("external_unresolved_at");
        ...
        builder
            .HasIndex(s => new { s.Status, s.UpdatedAt })
            .HasDatabaseName("ix_hotel_booking_sagas_status_updated_at");

        builder
            .HasIndex(s => new { s.ProviderBookingStatus, s.UpdatedAt })
