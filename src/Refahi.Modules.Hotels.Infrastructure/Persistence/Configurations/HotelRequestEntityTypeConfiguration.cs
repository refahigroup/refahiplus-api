...
public sealed class HotelRequestEntityTypeConfiguration : IEntityTypeConfiguration<HotelRequest>
{
    public void Configure(EntityTypeBuilder<HotelRequest> builder)
    {
        ...
        builder
            .HasIndex(r => new { r.Status, r.ExpireAt })
