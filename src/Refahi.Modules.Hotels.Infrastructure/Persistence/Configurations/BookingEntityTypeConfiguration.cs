...
namespace Refahi.Modules.Hotels.Infrastructure.Persistence.Configurations
{
    public sealed class BookingEntityTypeConfiguration : IEntityTypeConfiguration<Booking>
    {
        public void Configure(EntityTypeBuilder<Booking> builder)
        {
            ...
            builder
                .Property(b => b.Id)
                .HasConversion(id => id.Value, guid => new BookingId(guid))
                .HasColumnName("Id");
            ...
            builder
                .Property(b => b.ProviderBookingCode)
                .HasConversion(v => v.Value, s => new ProviderBookingCode(s))
                .HasColumnName("ProviderBookingCode")
                .HasMaxLength(100)
                .IsRequired();

            builder
                .Property(b => b.ProviderHotelId)
                .HasConversion(v => v.Value, l => new ProviderHotelId(l))
                .HasColumnName("ProviderHotelId")
                .IsRequired();

            builder
                .Property(b => b.ProviderRoomId)
                .HasConversion(v => v.Value, l => new ProviderRoomId(l))
                .HasColumnName("ProviderRoomId")
                .IsRequired();

            // DateRange (StayRange)
            var stay = builder.OwnsOne(b => b.StayRange);
            stay.Property(p => p.CheckIn).HasColumnName("CheckIn").IsRequired();

            stay.Property(p => p.CheckOut).HasColumnName("CheckOut").IsRequired();
            ...
            builder.OwnsOne(
                ...
                money =>
                {
                    money.Property(p => p.Amount).HasColumnName("BasePriceAmount").IsRequired();
            ...
            builder.OwnsOne(
                ...
                money =>
                {
                    money.Property(p => p.Amount).HasColumnName("MarginAmount").IsRequired();
            ...
            builder.OwnsOne(
                ...
                money =>
                {
                    money.Property(p => p.Amount).HasColumnName("CustomerPriceAmount").IsRequired();
            ...
            // RoomsCount
            builder.Property(b => b.RoomsCount).HasColumnName("RoomsCount").IsRequired();
            ...
            builder.OwnsMany(
                ...
                guests =>
                {
                    ...
                    guests.Property(g => g.Age).HasColumnName("Age").IsRequired();
            ...
            builder.OwnsOne(
                ...
                {
                    voucher
                        .Property(v => v.VoucherNumber)
                        .HasColumnName("VoucherNumber")
                        .HasMaxLength(100);

                    voucher.Property(v => v.Url).HasColumnName("VoucherUrl").HasMaxLength(1000);
                }
            );
            ...
            builder.Property(b => b.LockedUntil).HasColumnName("LockedUntil");
