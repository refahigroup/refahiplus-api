    ...
    : IEntityTypeConfiguration<HotelProviderBookingCacheEntry>
{
    public void Configure(EntityTypeBuilder<HotelProviderBookingCacheEntry> builder)
    {
        ...
        builder
            .Property(e => e.ProviderBookingCode)
            .HasMaxLength(120)
            .HasColumnName("provider_booking_code");

        builder.Property(e => e.ResponseJson).HasColumnType("jsonb").HasColumnName("response_json");

        builder.Property(e => e.FailureReason).HasMaxLength(1000).HasColumnName("failure_reason");

        builder
            .Property(e => e.CancellationIdempotencyKey)
            .HasMaxLength(160)
