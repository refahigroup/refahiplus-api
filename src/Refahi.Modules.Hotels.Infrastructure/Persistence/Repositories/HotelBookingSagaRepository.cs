...
public sealed class HotelBookingSagaRepository : IHotelBookingSagaRepository
{
    ...
    public Task<HotelBookingSagaState?> GetAsync(
        ...
        _dbContext.HotelBookingSagas.FirstOrDefaultAsync(
            s => s.SagaId == sagaId,
            cancellationToken
        );
    ...
    public Task<HotelBookingSagaState?> GetByHotelRequestIdAsync(
        ...
        _dbContext.HotelBookingSagas.FirstOrDefaultAsync(
            s => s.HotelRequestId == hotelRequestId,
            cancellationToken
        );
    ...
    )
    {
        ...
        return await _dbContext
            .HotelBookingSagas.Where(s =>
                statuses.Contains(s.Status) && s.UpdatedAt <= olderThanUtc
            )
