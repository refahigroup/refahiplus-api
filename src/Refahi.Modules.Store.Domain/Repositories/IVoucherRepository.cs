...
public sealed record VoucherRedemptionHistoryPage(
    int Total,
    IReadOnlyList<VoucherRedemptionHistoryRow> Items
);

public interface IVoucherRepository
{
    Task<Voucher?> GetByItemSequenceAsync(
    ...
    Task<IReadOnlyList<Voucher>> GetByStoreOrderAsync(
        Guid storeOrderId,
        CancellationToken ct = default
    );
    Task<VoucherRedemption?> GetRedemptionByIdempotencyAsync(
        Guid vendorUserId,
