...
namespace Refahi.Modules.SupplyChain.Infrastructure.Persistence.Migrations
{
    ...
    public partial class InitSupplyChain : Migration
    {
        ...
        {
            migrationBuilder.EnsureSchema(name: "supplychain");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NationalId = table.Column<string>(
                        type: "character varying(20)",
                        maxLength: 20,
                        nullable: true
                    ),
                    EconomicCode = table.Column<string>(
                        type: "character varying(20)",
                        maxLength: 20,
                        nullable: true
                    ),
        ...
        {
            migrationBuilder.DropTable(name: "supplier_attachments", schema: "supplychain");

            migrationBuilder.DropTable(name: "supplier_links", schema: "supplychain");

            migrationBuilder.DropTable(name: "suppliers", schema: "supplychain");
        }
    }
}
