...
public class GetShopProductsEndpoint : IEndpoint
{
    public void Map(object app)
    {
        ...
        routes
            .MapGet(
                "/admin/shops/{shopId:guid}/products",
                async (
                    Guid shopId,
                    bool? isActive,
                    int pageNumber,
    ...
    public void Map(object app)
    {
        ...
        routes
            .MapPost(
                ...
                {
                    var command = new AddProductToShopCommand(
                        shopId,
                        request.ProductId,
                        request.Price,
...
public class RemoveProductFromShopEndpoint : IEndpoint
{
    public void Map(object app)
    {
        ...
        routes
            .MapDelete(
                "/admin/shops/{shopId:guid}/products/{productId:guid}",
                async (Guid shopId, Guid productId, IMediator mediator, CancellationToken ct) =>
                {
...
public class EnableShopProductEndpoint : IEndpoint
{
    public void Map(object app)
    {
        ...
        routes
            .MapPatch(
                "/admin/shops/{shopId:guid}/products/{productId:guid}/enable",
                async (Guid shopId, Guid productId, IMediator mediator, CancellationToken ct) =>
                {
...
public class DisableShopProductEndpoint : IEndpoint
{
    public void Map(object app)
    {
        ...
        routes
            .MapPatch(
                "/admin/shops/{shopId:guid}/products/{productId:guid}/disable",
                async (Guid shopId, Guid productId, IMediator mediator, CancellationToken ct) =>
                {
    ...
    public void Map(object app)
    {
        ...
        routes
            .MapPut(
                ...
                {
                    var command = new UpdateShopProductCommand(
                        shopId,
                        productId,
                        request.Price,
                        request.DiscountedPrice,
...
public class ListShopProductVariantsEndpoint : IEndpoint
{
    public void Map(object app)
    {
        ...
        routes
            .MapGet(
                "/admin/shops/{shopId:guid}/products/{productId:guid}/variants",
                async (Guid shopId, Guid productId, IMediator mediator, CancellationToken ct) =>
                {
                    var result = await mediator.Send(
                        new ListShopProductVariantsQuery(shopId, productId),
                        ct
                    );
                    return Results.Ok(ApiResponseHelper.Success(result));
                }
...
public class UpsertShopProductVariantEndpoint : IEndpoint
{
    public void Map(object app)
    {
        ...
        routes
            .MapPut(
                "/admin/shops/{shopId:guid}/products/{productId:guid}/variants/{variantId:guid}",
                async (
                    Guid shopId,
                    Guid productId,
                    Guid variantId,
...
public class EnableShopProductVariantEndpoint : IEndpoint
{
    public void Map(object app)
    {
        ...
        routes
            .MapPatch(
                "/admin/shops/{shopId:guid}/products/{productId:guid}/variants/{variantId:guid}/enable",
                async (
                    Guid shopId,
                    Guid productId,
                    Guid variantId,
                ...
                {
                    await mediator.Send(
                        new EnableShopProductVariantCommand(shopId, productId, variantId),
                        ct
                    );
                    return Results.Ok(ApiResponseHelper.Success<object?>(null));
                }
...
public class DisableShopProductVariantEndpoint : IEndpoint
{
    public void Map(object app)
    {
        ...
        routes
            .MapPatch(
                "/admin/shops/{shopId:guid}/products/{productId:guid}/variants/{variantId:guid}/disable",
                async (
                    Guid shopId,
                    Guid productId,
                    Guid variantId,
                ...
                {
                    await mediator.Send(
                        new DisableShopProductVariantCommand(shopId, productId, variantId),
                        ct
                    );
                    return Results.Ok(ApiResponseHelper.Success<object?>(null));
                }
    ...
    public void Map(object app)
    {
        ...
        routes
            .MapDelete(
                ...
                {
                    await mediator.Send(
                        new RemoveShopProductVariantCommand(shopId, productId, variantId),
                        ct
                    );
                    return Results.NoContent();
                }
...
public class GetShopProductVariantBackfillAuditEndpoint : IEndpoint
{
    public void Map(object app)
    {
        ...
        routes
            .MapGet(
                "/admin/shop-product-variants/backfill/audit",
                async (
                    Guid? shopId,
                    Guid? productId,
                    int? detailLimit,
...
public class BackfillShopProductVariantsEndpoint : IEndpoint
{
    public void Map(object app)
    {
        ...
        routes
            .MapPost(
                "/admin/shop-product-variants/backfill",
                async (
...
public sealed record AddProductToShopRequest(
    Guid ProductId,
    long Price,
