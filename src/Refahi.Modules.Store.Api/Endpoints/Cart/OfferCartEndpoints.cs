...
public sealed class OfferCartEndpoints : IEndpoint
{
    public void Map(object app)
    {
        if (app is not IEndpointRouteBuilder routes)
            return;
        routes
            .MapPost("/{moduleSlug}/cart/items", AddAsync)
            .WithName("Store.AddOfferToCart")
            .WithTags("Store.Cart")
        ...
        routes
            .MapGet("/{moduleSlug}/cart", GetAsync)
            .WithName("Store.GetOfferCart")
            .WithTags("Store.Cart")
            .RequireAuthorization("UserOrAdmin")
            .RequireRateLimiting("StoreCart")
            .Produces<ApiResponse<OfferCartDto>>(StatusCodes.Status200OK);
        routes
            .MapPut("/{moduleSlug}/cart/items/{cartItemId:guid}", UpdateAsync)
            .WithName("Store.UpdateOfferCartItem")
            .WithTags("Store.Cart")
            .RequireAuthorization("UserOrAdmin")
            .RequireRateLimiting("StoreCart")
            .Produces<ApiResponse<OfferCartDto>>(StatusCodes.Status200OK)
        ...
        routes
            .MapDelete("/{moduleSlug}/cart/items/{cartItemId:guid}", RemoveAsync)
            .WithName("Store.RemoveOfferCartItem")
            .WithTags("Store.Cart")
            .RequireAuthorization("UserOrAdmin")
            .RequireRateLimiting("StoreCart")
            .Produces<ApiResponse<OfferCartDto>>(StatusCodes.Status200OK);
        routes
            .MapPost("/{moduleSlug}/cart/sync", SyncAsync)
            .WithName("Store.SyncOfferCart")
            .WithTags("Store.Cart")
            .RequireAuthorization("UserOrAdmin")
            .RequireRateLimiting("StoreCart")
            .Produces<ApiResponse<OfferCartDto>>(StatusCodes.Status200OK)
            ...
            .Produces<ApiErrorResponse>(StatusCodes.Status400BadRequest);
        routes
            .MapPost("/{moduleSlug}/cart/reconfirm", ReconfirmAsync)
            .WithName("Store.ReconfirmOfferCart")
            .WithTags("Store.Cart")
            .RequireAuthorization("UserOrAdmin")
            .RequireRateLimiting("StoreCart")
            .Produces<ApiResponse<OfferCartDto>>(StatusCodes.Status200OK)
