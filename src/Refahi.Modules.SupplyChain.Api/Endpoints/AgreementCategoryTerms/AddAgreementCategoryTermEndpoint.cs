...
public sealed class AddAgreementCategoryTermEndpoint : IEndpoint
{
    public void Map(object app)
    {
        ...
        routes.MapPost("/admin/agreements/{agreementId:guid}/agreement-category-terms", async (
            Guid agreementId,
            [FromBody] AgreementCategoryTermRequest body,
            IMediator mediator,
            CancellationToken cancellationToken) =>
        {
            var result = await mediator.Send(new AddAgreementCategoryTermCommand(
                agreementId,
                body.CategoryId,
            ...
            return Results.Created(
                ...
                ApiResponseHelper.Success(result, "شرط دسته‌بندی قرارداد با موفقیت افزوده شد", 201));
        })
