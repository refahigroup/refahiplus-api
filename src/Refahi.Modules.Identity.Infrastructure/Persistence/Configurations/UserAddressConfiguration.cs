...
public class UserAddressConfiguration : IEntityTypeConfiguration<UserAddress>
{
    public void Configure(EntityTypeBuilder<UserAddress> builder)
    {
        ...
        builder.Property(a => a.Title).HasMaxLength(100).IsRequired().HasColumnName("title");

        builder.Property(a => a.ProvinceId).IsRequired().HasColumnName("province_id");

        builder.Property(a => a.CityId).IsRequired().HasColumnName("city_id");
        ...
        builder
            .Property(a => a.ReceiverPhone)
            .HasMaxLength(20)
            .IsRequired()
            .HasColumnName("receiver_phone");

        builder.Property(a => a.Plate).HasMaxLength(20).HasColumnName("plate");

        builder.Property(a => a.Unit).HasMaxLength(20).HasColumnName("unit");

        builder.Property(a => a.Latitude).HasColumnName("latitude");

        builder.Property(a => a.Longitude).HasColumnName("longitude");

        builder.Property(a => a.IsDefault).IsRequired().HasColumnName("is_default");
        ...
        builder.HasIndex(a => a.UserId).HasDatabaseName("ix_user_addresses_user_id");
