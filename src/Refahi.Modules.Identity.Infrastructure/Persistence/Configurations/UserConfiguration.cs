...
public class UserConfiguration : IEntityTypeConfiguration<User>
{
    public void Configure(EntityTypeBuilder<User> builder)
    {
        ...
        builder.Property(u => u.MobileNumber).HasMaxLength(20).HasColumnName("mobile_number");

        builder.Property(u => u.Email).HasMaxLength(255).HasColumnName("email");

        builder.Property(u => u.Username).HasMaxLength(30).HasColumnName("username");

        builder.Property(u => u.PasswordHash).HasMaxLength(255).HasColumnName("password_hash");

        builder.Property(u => u.IsActive).IsRequired().HasColumnName("is_active");

        builder
            .Property(u => u.MobileApproved)
            .IsRequired()
            .HasDefaultValue(false)
            .HasColumnName("mobile_approved");

        builder
            .Property(u => u.EmailApproved)
            .IsRequired()
            .HasDefaultValue(false)
