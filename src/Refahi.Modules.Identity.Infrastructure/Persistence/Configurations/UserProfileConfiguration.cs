...
public class UserProfileConfiguration : IEntityTypeConfiguration<UserProfile>
{
    public void Configure(EntityTypeBuilder<UserProfile> builder)
    {
        ...
        builder.Property(p => p.LastName).HasMaxLength(100).IsRequired().HasColumnName("last_name");

        builder.Property(p => p.NationalCode).HasMaxLength(20).HasColumnName("national_code");
