...
namespace Refahi.Modules.Charge.Infrastructure.Migrations
{
    ...
    public partial class ChargeInit : Migration
    {
        ...
        {
            migrationBuilder.EnsureSchema(name: "charge");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    destination_mobile_number = table.Column<string>(
                        type: "character varying(20)",
                        maxLength: 20,
                        nullable: false
                    ),
                    origin_mobile_number = table.Column<string>(
                        type: "character varying(20)",
                        maxLength: 20,
                        nullable: true
                    ),
                    provider_product_id = table.Column<string>(
                        type: "character varying(150)",
                        maxLength: 150,
                        nullable: false
                    ),
                    product_caption = table.Column<string>(
                    ...
                    markup_percent = table.Column<decimal>(
                        type: "numeric(9,4)",
                        precision: 9,
                        scale: 4,
                        nullable: false
                    ...
                    customer_invoice_number = table.Column<string>(
                        type: "character varying(80)",
                        maxLength: 80,
                        nullable: false
                    ),
                    provider_rrn = table.Column<string>(
                    ...
                    operator_result_code = table.Column<string>(
                        type: "character varying(50)",
                        maxLength: 50,
                        nullable: true
                    ),
                    provider_message = table.Column<string>(
                    ...
                    expire_at = table.Column<DateTime>(
                        type: "timestamp with time zone",
                        nullable: false
                    ),
                    ...
                    fulfilled_at = table.Column<DateTime>(
                        type: "timestamp with time zone",
                        nullable: true
                    ),
                    next_reconciliation_at = table.Column<DateTime>(
                        type: "timestamp with time zone",
                        nullable: true
                    ),
                    reconciliation_count = table.Column<int>(type: "integer", nullable: false),
                    processing_lease_until = table.Column<DateTime>(
                        type: "timestamp with time zone",
                        nullable: true
                    ),
                    processing_lease_owner = table.Column<string>(
                        type: "character varying(100)",
                        maxLength: 100,
                        nullable: true
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    charge_request_id = table.Column<Guid>(type: "uuid", nullable: false),
                    encrypted_serial = table.Column<string>(
                        type: "character varying(2000)",
                        maxLength: 2000,
                        nullable: false
                    ),
                    encrypted_code = table.Column<string>(
                        type: "character varying(2000)",
                        maxLength: 2000,
                        nullable: false
                    ),
        ...
        {
            migrationBuilder.DropTable(name: "charge_fulfillment_attempts", schema: "charge");

            migrationBuilder.DropTable(name: "charge_markup_rules", schema: "charge");

            migrationBuilder.DropTable(name: "charge_pins", schema: "charge");

            migrationBuilder.DropTable(name: "charge_requests", schema: "charge");
        }
    }
}
