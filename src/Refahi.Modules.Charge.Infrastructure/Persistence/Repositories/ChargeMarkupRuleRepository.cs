    ...
    )
    {
        return _db
            ...
            .Where(x =>
                ...
                && (x.Operator == null || x.Operator == @operator)
                && (x.ServiceType == null || x.ServiceType == serviceType)
            )
