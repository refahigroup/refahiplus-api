...
public sealed class ChargePinConfiguration : IEntityTypeConfiguration<ChargePin>
{
    public void Configure(EntityTypeBuilder<ChargePin> b)
    {
        ...
        b.Property(x => x.EncryptedSerial).HasColumnName("encrypted_serial").HasMaxLength(2000);

        b.Property(x => x.EncryptedCode).HasColumnName("encrypted_code").HasMaxLength(2000);
