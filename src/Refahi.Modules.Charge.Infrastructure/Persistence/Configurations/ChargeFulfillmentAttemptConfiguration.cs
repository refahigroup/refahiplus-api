...
public sealed class ChargeFulfillmentAttemptConfiguration
    : IEntityTypeConfiguration<ChargeFulfillmentAttempt>
{
    public void Configure(EntityTypeBuilder<ChargeFulfillmentAttempt> b)
    {
        ...
        b.Property(x => x.ProviderCallLogId).HasColumnName("provider_call_log_id");
