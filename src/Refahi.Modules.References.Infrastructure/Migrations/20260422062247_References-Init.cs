...
namespace Refahi.Modules.References.Infrastructure.Migrations
{
    ...
    public partial class ReferencesInit : Migration
    {
        ...
        {
            migrationBuilder.EnsureSchema(name: "references");
        ...
        {
            migrationBuilder.DropTable(name: "cities", schema: "references");

            migrationBuilder.DropTable(name: "provinces", schema: "references");
        }
    }
}
