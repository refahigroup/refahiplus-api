...
public class RemoveProductFromShopCommandHandler : IRequestHandler<RemoveProductFromShopCommand>
{
    ...
    public async Task Handle(RemoveProductFromShopCommand request, CancellationToken cancellationToken)
    {
