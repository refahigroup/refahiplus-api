...
public class EnableShopProductVariantCommandValidator
    : AbstractValidator<EnableShopProductVariantCommand>
{
    public EnableShopProductVariantCommandValidator()
    {
        ...
        RuleFor(x => x.ProductVariantId).NotEmpty().WithMessage("شناسه تنوع محصول الزامی است");
    }
}

public class DisableShopProductVariantCommandValidator
    : AbstractValidator<DisableShopProductVariantCommand>
{
...
public class RemoveShopProductVariantCommandValidator
    : AbstractValidator<RemoveShopProductVariantCommand>
{
