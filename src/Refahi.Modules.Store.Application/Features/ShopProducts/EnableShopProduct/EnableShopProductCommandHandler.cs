...
public class EnableShopProductCommandHandler : IRequestHandler<EnableShopProductCommand>
{
    ...
    public async Task Handle(EnableShopProductCommand request, CancellationToken cancellationToken)
    {
