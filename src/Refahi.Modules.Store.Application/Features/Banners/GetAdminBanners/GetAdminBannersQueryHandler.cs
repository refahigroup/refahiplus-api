...
public class GetAdminBannersQueryHandler
    : IRequestHandler<GetAdminBannersQuery, List<AdminBannerDto>>
{
    ...
    public async Task<List<AdminBannerDto>> Handle(
        GetAdminBannersQuery request,
