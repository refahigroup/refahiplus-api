...
public sealed class UpdateVariantAttributeValueCommandHandler
    : IRequestHandler<UpdateVariantAttributeValueCommand, Unit>
{
    ...
    public async Task<Unit> Handle(
        UpdateVariantAttributeValueCommand request,
