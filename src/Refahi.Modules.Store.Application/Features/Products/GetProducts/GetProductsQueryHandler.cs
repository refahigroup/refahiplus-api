...
public class GetProductsQueryHandler : IRequestHandler<GetProductsQuery, ProductsPagedResponse>
{
    ...
    public GetProductsQueryHandler(IProductRepository productRepo, IShopRepository shopRepo)
    {
        _productRepo = productRepo;
        _shopRepo = shopRepo;
    }

    public async Task<ProductsPagedResponse> Handle(GetProductsQuery request, CancellationToken cancellationToken)
    {
