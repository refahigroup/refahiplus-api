...
public class GetProductSessionsQueryHandler
    : IRequestHandler<GetProductSessionsQuery, List<ProductSessionDto>>
{
    ...
    public async Task<List<ProductSessionDto>> Handle(
        GetProductSessionsQuery request,
        CancellationToken cancellationToken
    )
    {
        var sessions = await _sessionRepo.GetAvailableByProductIdAsync(
            request.ProductId,
            cancellationToken
        );
