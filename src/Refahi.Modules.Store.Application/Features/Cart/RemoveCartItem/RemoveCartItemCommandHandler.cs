...
public class RemoveCartItemCommandHandler
    : IRequestHandler<RemoveCartItemCommand, RemoveCartItemResponse>
{
    private readonly ICartRepository _cartRepo;

    public RemoveCartItemCommandHandler(ICartRepository cartRepo) => _cartRepo = cartRepo;

    public async Task<RemoveCartItemResponse> Handle(
