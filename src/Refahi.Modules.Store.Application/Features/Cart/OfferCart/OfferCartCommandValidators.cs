...
public sealed class UpdateOfferCartItemCommandValidator
    : AbstractValidator<UpdateOfferCartItemCommand>
{
...
public sealed class RemoveOfferCartItemCommandValidator
    : AbstractValidator<RemoveOfferCartItemCommand>
{
...
public sealed class ReconfirmOfferCartCommandValidator
    : AbstractValidator<ReconfirmOfferCartCommand>
{
    ...
    public SyncOfferCartCommandValidator()
    {
        ...
        RuleForEach(x => x.Items)
            .ChildRules(item =>
            {
                ...
                item.RuleFor(x => x.SnapshotOriginalUnitPriceMinor)
                    .GreaterThan(0)
                    .WithMessage("قیمت اصلی snapshot الزامی است");
                item.RuleFor(x => x.SnapshotFinalUnitPriceMinor)
