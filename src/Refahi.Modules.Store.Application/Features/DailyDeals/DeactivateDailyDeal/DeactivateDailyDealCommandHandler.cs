...
public class DeactivateDailyDealCommandHandler
    : IRequestHandler<DeactivateDailyDealCommand, DeactivateDailyDealResponse>
{
    private readonly IDailyDealRepository _dealRepo;

    public DeactivateDailyDealCommandHandler(IDailyDealRepository dealRepo) => _dealRepo = dealRepo;

    public async Task<DeactivateDailyDealResponse> Handle(
        DeactivateDailyDealCommand request,
