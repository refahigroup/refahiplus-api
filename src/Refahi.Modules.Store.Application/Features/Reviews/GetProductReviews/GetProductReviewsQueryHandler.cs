...
public class GetProductReviewsQueryHandler
    : IRequestHandler<GetProductReviewsQuery, ProductReviewsResponse>
{
    private readonly IReviewRepository _reviewRepo;

    public GetProductReviewsQueryHandler(IReviewRepository reviewRepo) => _reviewRepo = reviewRepo;

    public async Task<ProductReviewsResponse> Handle(
    ...
    )
    {
        ...
        var averageRating = await _reviewRepo.GetAverageRatingAsync(
            request.ProductId,
            cancellationToken
        );
