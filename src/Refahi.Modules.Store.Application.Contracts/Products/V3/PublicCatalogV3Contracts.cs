...
public sealed record PublicOfferSelectionV3Dto(
    Guid ShopId,
    Guid ProductId,
    Guid? VariantId,
    Guid? SessionId
...
public sealed record PublicOfferV3Dto(
    Guid Id,
    Guid ProductId,
    Guid ShopId,
    string ShopName,
...
public sealed record PublicProductPriceSummaryV3Dto(
    string DisplayMode,
...
public sealed record PublicProductCatalogItemV3Dto(
    Guid ProductId,
    string Title,
    string Slug,
    string? Description,
...
public sealed record PublicProductCatalogV3Page(
    IReadOnlyList<PublicProductCatalogItemV3Dto> Items,
    int Total,
    int Page,
    int PageSize
);

public sealed record GetPublicProductCatalogV3Query(
    string ModuleSlug,
    string? Search,
    int? CategoryId,
    Guid? ShopId,
...
public sealed record PublicProductDetailV3Dto(
...
public sealed record GetPublicProductDetailV3Query(
    string ModuleSlug,
    string ProductSlug,
    Guid? ShopId = null,
