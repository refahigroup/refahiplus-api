...
public sealed class StoreInPersonFinancialPlannerTests
{
    ...
    private static readonly Guid ProviderWalletId = Guid.Parse(
        "20000000-0000-0000-0000-000000000001"
    );
    private static readonly Guid RevenueWalletId = Guid.Parse(
    ...
    private static StoreInPersonFinancialPlanner CreatePlanner(IMediator mediator) =>
        new(
            mediator,
            Options.Create(
                new StorePaymentDistributionOptions
                {
